...
messages =  [
        {"role": "system", "content": "You and the user are going to play a game of 'who am i. You introduce the game and ask if the user wants to play. You know who the person is, the user is guessing who it is. Your tone should be friendly. You will give an initial clue. Try to respond in less than 10 words."},
...
class StreamHandler:
    ...
    def process(self):
        if self.fileready:
            ...
            #    user_input += ("[%.2fs -> %.2fs] %s" % (segment.start, segment.end, segment.text))
            #print(user_input)
            #content = user_input
